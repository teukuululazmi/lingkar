...
<div class="container-fluid">
    ...
    <div class="card">
		<div class="card-header header-elements-inline">
			<h5 class="card-title">Slider Foto</h5>
			<div class="header-elements">
				<div class="list-icons">
					<a class="list-icons-item" data-action="collapse"></a>
				</div>
		...
		<table class="table datatable-basic">
			...
			<tbody>
					...
					<tr class="text-center">
						...
						<td><img width="200px" src="{{ url('/fotoslider/'.$item->foto) }}"></td>
						<td class="text-center">
                            <a href="{{ route('sliderDelete', $item->id) }}" class="btn-sm btn-danger delete" data-popup="tooltip" title="Delete"><i class="icon-bin2"></i></a>	
						</td>
					</tr>
                    @endforeach
			</tbody>
