...
<html lang="en">
	...
	<head>
		...
		<title>Lingkaran Kreatif - About</title>
	...
	<body class="default-header-p">
		...
		<section id="breadcrumb-section" class="breadcrumb-section clearfix">
			<div class="jarallax" style="background-image: url(assets/images/slider/slider01.jpg);">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="management-item sr-fade2">
									...
									<p class="black-color m-0">
										<strong>
											<i>1. Produk dan Services yang berkualitas.</i>	
											<i>2. Menciptakan produk jasa yang berorientasi kepada pelanggan.</i>	
											<i>3. Inovasi untuk meningkatkan kepuasan costumer.</i>	
											<i>4. Menjadi partner terpercaya.</i>	
										</strong>
									</p>
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="management-item sr-fade3">
									...
									{{-- <p class="black-color mb-30">
										Menjadi perusahaan event organizer yang paling terpercaya dan selalu memberikan nilai lebih kepada pelanggan.
									</p> --}}
									<p class="black-color m-0">
										<strong>
											<i>
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="section-title mb-50 sr-fade1">
							...
							<h2 class="big-title">Lingkaran Kreatif <strong>Advantages</strong></h2>
						</div>
					</div>
